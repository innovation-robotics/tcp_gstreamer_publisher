...
class PublisherNodeClass(Node):
    ...
    def __init__(self):
        ...
        super().__init__('screw_driver_detector_node')
        ...
        calib_yaml = "/home/ahmed/moveit2/ws_moveit_humble_control/src/ros2_opencv/ros2_opencv/rapoo_camera:_rapoo_camera.yaml"
